      ...
      <section id="connect" className="py-32 bg-[#050505] border-t border-[#111111] px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#1A1A1A] border border-[#333333] mb-8">
            ...
            <span className="text-[10px] font-bold uppercase tracking-wider text-[#FF9000]">Let's Connect</span>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <a href="https://linkedin.com/in/sourabh-sahu-08" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-6 py-3 rounded-lg border border-[#333333] bg-[#0A0A0A] hover:bg-[#111111] hover:border-[#FF9000] transition-colors group">
              <svg viewBox="0 0 24 24" className="w-5 h-5 fill-zinc-400 group-hover:fill-[#0a66c2] transition-colors"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              <span className="font-semibold text-zinc-300 group-hover:text-white transition-colors">LinkedIn</span>
            </a>
            
            <a href="mailto:contact@stuhub.app" className="flex items-center gap-2 px-6 py-3 rounded-lg border border-[#333333] bg-[#0A0A0A] hover:bg-[#111111] hover:border-[#FF9000] transition-colors group">
